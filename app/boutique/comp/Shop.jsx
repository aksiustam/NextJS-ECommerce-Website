...
const ShopPage = (props) => {
  ...
  useEffect(() => {
    ...
    const filteredProducts = sortMyProducts(
      searchMyProducts(filterMyProducts())
    );
            ...
            <div className="col-lg-9">
              <div className="row tw-justify-center md:tw-justify-end tw-mb-4  tw-mt-6 md:tw-mt-0">
                <div className="tw-flex tw-gap-3">
                  <img src={bioimg} className="tw-w-5 tw-h-5" alt="bio" />
                  <span className="tw-font-bold">Bio</span>
                </div>
                <div className="tw-flex tw-gap-3 tw-ml-4">
                  <img src={ofgimg} className="tw-w-5 tw-h-5" alt="ofg" />
