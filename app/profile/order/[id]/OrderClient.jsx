...
const OrderClient = (props) => {
  ...
  const sipdata = user.Siparis.find((item) => item.id === parseInt(id)) || null;
    ...
    <>
      {sipdata !== null && (
        <div className="row">
          ...
          <div className="col-sm-12 col-md-12 col-lg-12 col-12  tw-mb-3">
            <button className="btn btn-info theme_btn_one tw-py-3 tw-font-bold">
              <Link href={`/order-complete/${sipdata?.token}`}>
                Votre Facture
              </Link>
            </button>
          </div>
      ...
      {sipdata === null && (
        <div className="row">
          <div className="col-sm-12 col-md-12 col-lg-12 col-12">
            <h4>Une erreur est survenue sur la page.</h4>
          </div>
        </div>
      )}
    </>
